                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <p>Herramienta para modificar los platos de la carta <a href="#menu-toggle" class="btn btn-default" id="menu-toggle">Ocultar menu</a></p>
                        ...
                        <?php foreach (@$platos as $value): ?>
                            <div style="min-height: 560px;"  class="col-lg-4 panel panel-default">
                                <div class="row panel-body">
                                    <img id="imgf" class="col-lg-5 img-thumbnail img-responsive" src="../../ildolce/img-platos/<?php echo $value->imagen; ?>"/>
                                    ...
                                    <form  id="<?php echo $value->id ?>">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" required="required"
                                                   placeholder="Nombre" value="<?php echo $value->nombre ?>">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div style="margin-top:10px;"  class="form-group">
                                            ...
                                            <button  class="mod btn btn-primary">Modificar</button>
                                        </div>
        ...
        <script>
            $(document).ready(function() {
                ...
                $(".mod").on("click", function(e) {
                    ...
                    dest = "include/peti-dolce.php?op=5";
                    param = {
                        "id": id,
                        "nombre": $("#" + id + " input:eq(0)").val(),
                        "descripcion": $("#" + id + " textarea").val(),
                        "precio": $("#" + id + " input:eq(1)").val(),
                ...
                $(".imgplato ").on("change", function(e) {
                    ...
                    ruta = "include/peti-dolce.php?op=6";
                ...
                $(".borrar").on("click", function(e) {
                    ...
                    dest = "include/peti-dolce.php?op=7";
                    param = {
                        "id": id,
                        "imagen": img                      
                    };
