...
function enviarpromo($param, $datos) {
    $fecha = new DateTime();
...
//Set the subject line
    $mail->Subject = $datos['nombre'];
//Read an HTML message body from an external file, convert referenced images to embedded,
//convert HTML into a basic plain-text alternative body
    $mail->Body = "<div style=' width:60%; margin:0 auto;'><img style=' width:100%; ' src='http://atabernadachorima.es/images/ofertabienvenida.png'/></div><br><br><h3 style='background-color: #5882FA; width:90%; margin:0 auto; text-align:center; border-radius: 15px 15px 0px 0px; padding:5px;'>Ofertas A Taberna da Chorima</h3>"
            . "<br>"
            ...
            . "<p style='text-align:center;'><b>Descripción</b>: " . $datos['descripcion'] . "</p>"
            . "<p style='text-align:center;'><a href='http://atabernadachorima.es/ofertas' style='font-size:18px;'>Recolle o teu código aquí</a></p></div>"
            . "<p>Esta oferta estará dispoñible durante 30 días naturais a partir do " . date('d') . "/" . date('m') . "/" . date('Y') . "</p>"
            . "<div style=' width:100%;'>"
