					...
					<div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
						...
						<ul class="nav navbar-nav">
							<li class="hvr-bounce-to-bottom <?php echo $resturante; ?>" ><a href="/"><?php echo nav_inicio ?> </a></li>
                                                        <li class="hvr-bounce-to-bottom <?php echo $galeria; ?>"><a href="/galeria/"><?php echo nav_sobrenosotros ?></a></li>
            ...
            <div class="container">
                <div class="get-in-grids">
                    ...
                    <div class="get-in-grid-right">
                        ...
                        <small><a class="chorimacolor" href="#"><?php echo subscripcionlink; ?></a></small>
                    </div>
                    <div class="clearfix"> </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="footer-grids">
                    ...
                    <div class="col-md-3 footer-grid">
                        ...
                        <ul>
                            <li><a id="gl" href="#">A Galeguesa</a></li>
                            <li><a href="#">A Gula Galega</a></li>
